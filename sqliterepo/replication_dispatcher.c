		...
		gboolean prometheus_format)
{
	...
	if (prometheus_format) {
		g_string_append_printf(gstr,
				"meta_base_cache_size{type=\"max\"} %u\n"
				"meta_base_cache_size{type=\"soft_max\"} %u\n"
				"meta_base_cache_size{type=\"hot\"} %u\n"
				"meta_base_cache_size{type=\"cold\"} %u\n"
				"meta_base_cache_size{type=\"used\"} %u\n",
