...
class Account(WerkzeugApp):
    ...
    def __init__(self, conf, backend, iam_db, logger=None):
        ...
        self.url_map = Map([
            ...
            Rule('/v1.0/account/release-bucket', endpoint='bucket_release',
                 methods=['POST']),
            Rule('/v1.0/account/set-owner-bucket', endpoint='bucket_owner_set',
                 methods=['PUT']),
    ...
    # ACCT{{
    # PUT /v1.0/bucket/set-owner-bucket?id=bucket_name
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    #
    ...
    # .. code-block:: http
    #
    #    PUT /v1.0/bucket/set-owner-bucket?id=bucket_name HTTP/1.1
    #    Host: 127.0.0.1:6013
    #    User-Agent: curl/7.47.0
    #    Accept: */*
    #    Content-Length: 84
    ...
    # ACCT{{
    # GET /v1.0/bucket/get-owner-bucket?id=bucket_name
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    #
    ...
    # .. code-block:: http
    #
    #    PUT /v1.0/bucket/get-owner-bucket?id=bucket_name HTTP/1.1
    #    Host: 127.0.0.1:6013
    #    User-Agent: curl/7.47.0
    #    Accept: */*
    #    Content-Length: 84
